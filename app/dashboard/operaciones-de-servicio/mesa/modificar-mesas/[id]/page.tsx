      ...
      <Card className="sticky top-0 z-50 mb-4">
        <CardHeader>
          <div className="flex items-center gap-2">
            <CardTitle>Modificar Mesas</CardTitle>
            <p>ID recibido: {id}</p>
            <div className="ml-auto flex items-center gap-2">
              ...
              <Link href="/dashboard/operaciones-de-servicio/mesa">
                <Button size="sm" className="h-8 gap-1">
        ...
        <CardContent className="mt-4">
          <form className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 md:col-span-2">
              <label className="block mb-1 font-medium">Código de Mesa</label>
              <Input
                type="number"
                placeholder="0"
            ...
            <div className="col-span-12 md:col-span-6">
              <label className="block mb-1 font-medium">Número de Mesa</label>
              <Input
                type="text"
            ...
            {/*<div className="col-span-12 md:col-span-4">
              <label className="block mb-1 font-medium">Tipo de Almacén</label>
