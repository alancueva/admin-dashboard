...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center">
            <div className="w-full max-w-6xl overflow-hidden shadow-2xl flex">
                {/* Left Side - Hero Section */}
                <div className="w-1/2 flex flex-col rounded-3xl justify-end relative overflow-hidden">
                    <Image src="/void-paisaje.png" alt="Hero Image" layout="fill" objectFit="cover" />
                </div>

                {/* Right Side - Form Section */}
                <div className="w-1/2 bg-black p-2 flex flex-col justify-center">
